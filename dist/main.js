...
async function run() {
    try {
        ...
        var actionItems = await (0, actionItems_1.GetActionItems)();
        console.log(actionItems);
        console.log("Get meeting topics");
        var meetingTopics = await (0, meetingTopics_1.GetMeetingTopics)();
...
function hydrateIssueTemplate(actionItems, meetingTopics) {
    ...
    var issueTemplate = fs_1.default.readFileSync('issueTemplate.md', 'utf8');
